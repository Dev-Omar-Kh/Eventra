...
export default function TopEvents() {
    ...
    return <React.Fragment>
        ...
        <section className='py-[3.125rem] p_x flex flex-col gap-10'>

            <div className='w-full flex flex-wrap items-center justify-between gap-5'>

                <Title title={'weOfferWord'} />

                <div className='flex items-center gap-2.5 max-[465px]:w-full max-[465px]:grid max-[465px]:grid-cols-2'>
